...
func ContextToHTTP(tracer opentracing.Tracer, logger log.Logger) flexithttp.RequestFunc {
...
func HTTPToContext(tracer opentracing.Tracer, operationName string, logger log.Logger) flexithttp.RequestFunc {
	return func(ctx context.Context, req *http.Request) context.Context {
