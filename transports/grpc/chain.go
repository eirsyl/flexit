...
// WithUnaryClientChain is a grpc.ClientConn config option that accepts multiple unary interceptors.
// Basically syntactic sugar.
...
// WithStreamClientChain is a grpc.DialConn config option that accepts multiple stream interceptors.
// Basically syntactic sugar.
